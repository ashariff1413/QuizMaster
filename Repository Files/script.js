class QuizGame {
    ...
    displayQuestion() {
        ...
        if (progressDisplay) {
            if (this.isAIBattle && this.currentAI === 'hacker') {
                ...
                progressDisplay.textContent = `${this.questionsAnswered}/${this.maxQuestions}`;
            } else if (this.isAIBattle) {
                // Other AI battles show round number
                progressDisplay.textContent = `Round ${this.questionsAnswered}`;
            } else {
                // Normal quiz shows question count
                progressDisplay.textContent = `${this.questionsAnswered}/${this.maxQuestions}`;
            }
        }
    ...
    endGame(won) {
        ...
        if (this.isAIBattle) {
            ...
            document.querySelector('.ai-side').classList.add('hidden');
        ...
        document.getElementById('highest-level').textContent = this.difficulty;
    ...
    renderCustomCategories() {
        ...
        if (!container) {
            // Create the custom categories section if it doesn't exist
            this.createCustomCategoriesSection();
            return;
        }
